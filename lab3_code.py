...
# Class Dollar's exchange rate should be 20 units of Currency.8
class Dollar(Currency):
    ...
    def conversion(self, result_currency_reference):
        return Currency.conversion(self, result_currency_reference)
...
class Bank:
    ...
    def __init__(self, name, unit, initial_value=0):
        self.name = name
        self.unit = unit
        self.current_account = Currency(initial_value)
    ...
    def deposit(self, currency_instance):
        if self.unit == type(currency_instance):
